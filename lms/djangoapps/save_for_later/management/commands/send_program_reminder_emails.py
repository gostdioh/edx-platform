...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for batch_num in range(int(num_batches)):
            ...
            for saved_program in saved_programs:
                ...
                if program:
                    ...
                    if email_sent:
                        reminder_email_sent_users.append(saved_program.id)
                    else:
        ...
        SavedProgram.objects.filter(id__in=reminder_email_sent_users).update(reminder_email_sent=True)
